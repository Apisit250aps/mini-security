...
export default function OrganizationEmployeeNewView() {
  const router = useRouter();
  const { activeOrganization, isLoading } = useActiveOrganization();

  return (
    <PageLayout
      pageId="organizationEmployeeNew"
      isLoading={isLoading}
      actions={
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle>
                    สร้างบัญชีพนักงานใหม่ ({activeOrganization.name})
                  </CardTitle>
                  <CardDescription>
            ...
            <CardContent>
              <UserCreateForm
                ...
                onSuccess={() =>
                  router.push(buildPageUrl('organizationEmployee'))
                }
              />
            </CardContent>
          </Card>
