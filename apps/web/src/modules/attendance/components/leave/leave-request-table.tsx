...
export default function LeaveRequestTable({
  ...
  const { data = [], isLoading: isLeaveLoading } =
    useLeaveRequestsQueries(companyId);
  ...
  const columns = useMemo(
    () => leaveRequestColumns({ membersMap, usersMap }),
    [membersMap, usersMap],
  );

  const isLoading = isLeaveLoading || isMembersLoading || isUsersLoading;
