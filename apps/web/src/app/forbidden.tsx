...
export default function Forbidden() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#FBFBFA]">
      {/* Ambient background — subtle warm red tint */}
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-0 z-0"
        style={{
          background:
            'radial-gradient(ellipse 60% 50% at 50% 40%, rgba(159,47,45,0.025) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-xl mx-auto gap-8">
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M5 1L1.5 2.5V5c0 2 1.5 3.5 3.5 4C7 8.5 8.5 7 8.5 5V2.5L5 1Z"
                stroke="#9F2F2D"
                strokeWidth="1.2"
