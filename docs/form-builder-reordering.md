...
- Requires `form_template:update`, the persisted version's company scope, and a matching template/version. Only DRAFT is editable.
...
- Test draft retained at `/company/forms/templates/01a0a361-8ebd-76f8-9996-6eb6dfa8adf8/builder`.
...
- PUT and DELETE `/forms/templates/:id/fields/:fieldId` enforce update permission, stored company scope, matching template/version, and DRAFT status. Client ownership/order overrides are rejected.
