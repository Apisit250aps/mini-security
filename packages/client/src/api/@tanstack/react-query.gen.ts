...
import {
  ...
  formServicesDownloadAttachment,
  formServicesEditField,
  formServicesFinalizeReview,
  formServicesGetAssignment,
  formServicesGetPlan,
...
import type {
  ...
  FormServicesDeleteAttachmentError,
  FormServicesDeleteAttachmentResponse,
  FormServicesDeleteFieldData,
  FormServicesDeleteFieldError,
  FormServicesDeleteFieldResponse,
  FormServicesDeleteSectionData,
  FormServicesDeleteSectionError,
  FormServicesDeleteSectionResponse,
  FormServicesDownloadAttachmentData,
  FormServicesDownloadAttachmentError,
  FormServicesEditFieldData,
  FormServicesEditFieldError,
  FormServicesEditFieldResponse,
  FormServicesFinalizeReviewData,
  FormServicesFinalizeReviewError,
  FormServicesFinalizeReviewResponse,
  FormServicesGetAssignmentData,
  FormServicesGetAssignmentError,
  FormServicesGetAssignmentResponse,
  FormServicesGetPlanData,
  FormServicesGetPlanError,
  FormServicesGetPlanResponse,
  FormServicesGetReviewDetailData,
  FormServicesGetReviewDetailError,
  ...
  FormServicesRecordAnswerReviewError,
  FormServicesRecordAnswerReviewResponse,
  FormServicesRecordSectionReviewData,
  FormServicesRecordSectionReviewError,
  FormServicesRecordSectionReviewResponse,
  FormServicesReorderFieldsData,
  FormServicesReorderFieldsError,
  FormServicesReorderFieldsResponse,
  FormServicesReorderSectionsData,
  FormServicesReorderSectionsError,
  FormServicesReorderSectionsResponse,
  FormServicesReplaceAssignmentData,
  FormServicesReplaceAssignmentError,
  ...
  FormServicesUploadAttachmentError,
...
export const formServicesListMyAssignmentsQueryKey = (
  options?: Options<FormServicesListMyAssignmentsData>,
) => createQueryKey('formServicesListMyAssignments', options);

/**
 * List my assignments
 */
export const formServicesListMyAssignmentsOptions = (
  options?: Options<FormServicesListMyAssignmentsData>,
) =>
  queryOptions<
    FormServicesListMyAssignmentsResponse,
    AxiosError<FormServicesListMyAssignmentsError>,
    FormServicesListMyAssignmentsResponse,
    ReturnType<typeof formServicesListMyAssignmentsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const formServicesGetAssignmentQueryKey = (
  options: Options<FormServicesGetAssignmentData>,
) => createQueryKey('formServicesGetAssignment', options);

/**
 * Get assignment
 */
export const formServicesGetAssignmentOptions = (
  options: Options<FormServicesGetAssignmentData>,
) =>
  queryOptions<
    FormServicesGetAssignmentResponse,
    AxiosError<FormServicesGetAssignmentError>,
    FormServicesGetAssignmentResponse,
    ReturnType<typeof formServicesGetAssignmentQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Cancel assignment
 */
export const formServicesCancelAssignmentMutation = (
  options?: Partial<Options<FormServicesCancelAssignmentData>>,
): UseMutationOptions<
  FormServicesCancelAssignmentResponse,
  AxiosError<FormServicesCancelAssignmentError>,
  Options<FormServicesCancelAssignmentData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesCancelAssignmentResponse,
    AxiosError<FormServicesCancelAssignmentError>,
 ...
 * Replace assignment
 */
export const formServicesReplaceAssignmentMutation = (
  options?: Partial<Options<FormServicesReplaceAssignmentData>>,
): UseMutationOptions<
  FormServicesReplaceAssignmentResponse,
  AxiosError<FormServicesReplaceAssignmentError>,
  Options<FormServicesReplaceAssignmentData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesReplaceAssignmentResponse,
    AxiosError<FormServicesReplaceAssignmentError>,
...
export const formServicesDeleteAttachmentMutation = (
  options?: Partial<Options<FormServicesDeleteAttachmentData>>,
): UseMutationOptions<
  FormServicesDeleteAttachmentResponse,
  AxiosError<FormServicesDeleteAttachmentError>,
  Options<FormServicesDeleteAttachmentData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesDeleteAttachmentResponse,
    AxiosError<FormServicesDeleteAttachmentError>,
...
export const formServicesDownloadAttachmentQueryKey = (
  options: Options<FormServicesDownloadAttachmentData>,
) => createQueryKey('formServicesDownloadAttachment', options);

export const formServicesDownloadAttachmentOptions = (
  options: Options<FormServicesDownloadAttachmentData>,
) =>
  queryOptions<
    unknown,
    AxiosError<FormServicesDownloadAttachmentError>,
    unknown,
    ReturnType<typeof formServicesDownloadAttachmentQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const formServicesListOccurrencesQueryKey = (
  options: Options<FormServicesListOccurrencesData>,
) => createQueryKey('formServicesListOccurrences', options);

/**
 * List form occurrences
 */
export const formServicesListOccurrencesOptions = (
  options: Options<FormServicesListOccurrencesData>,
) =>
  queryOptions<
    FormServicesListOccurrencesResponse,
    AxiosError<FormServicesListOccurrencesError>,
    FormServicesListOccurrencesResponse,
    ReturnType<typeof formServicesListOccurrencesQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const formServicesOpenOccurrencesMutation = (
  options?: Partial<Options<FormServicesOpenOccurrencesData>>,
): UseMutationOptions<
  FormServicesOpenOccurrencesResponse,
  AxiosError<FormServicesOpenOccurrencesError>,
  Options<FormServicesOpenOccurrencesData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesOpenOccurrencesResponse,
    AxiosError<FormServicesOpenOccurrencesError>,
...
export const formServicesListOccurrenceAssignmentsQueryKey = (
  options: Options<FormServicesListOccurrenceAssignmentsData>,
) => createQueryKey('formServicesListOccurrenceAssignments', options);

/**
 * List occurrence assignments
 */
export const formServicesListOccurrenceAssignmentsOptions = (
  options: Options<FormServicesListOccurrenceAssignmentsData>,
) =>
  queryOptions<
    FormServicesListOccurrenceAssignmentsResponse,
    AxiosError<FormServicesListOccurrenceAssignmentsError>,
    FormServicesListOccurrenceAssignmentsResponse,
    ReturnType<typeof formServicesListOccurrenceAssignmentsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Cancel occurrence
 */
export const formServicesCancelOccurrenceMutation = (
  options?: Partial<Options<FormServicesCancelOccurrenceData>>,
): UseMutationOptions<
  FormServicesCancelOccurrenceResponse,
  AxiosError<FormServicesCancelOccurrenceError>,
  Options<FormServicesCancelOccurrenceData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesCancelOccurrenceResponse,
    AxiosError<FormServicesCancelOccurrenceError>,
...
export const formServicesListPlansQueryKey = (
  options: Options<FormServicesListPlansData>,
) => createQueryKey('formServicesListPlans', options);

/**
 * List form plans
 */
export const formServicesListPlansOptions = (
  options: Options<FormServicesListPlansData>,
) =>
  queryOptions<
    FormServicesListPlansResponse,
    AxiosError<FormServicesListPlansError>,
    FormServicesListPlansResponse,
    ReturnType<typeof formServicesListPlansQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Create form plan
 */
export const formServicesCreatePlanMutation = (
  options?: Partial<Options<FormServicesCreatePlanData>>,
): UseMutationOptions<
  FormServicesCreatePlanResponse,
  AxiosError<FormServicesCreatePlanError>,
  Options<FormServicesCreatePlanData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesCreatePlanResponse,
    AxiosError<FormServicesCreatePlanError>,
...
export const formServicesGetPlanQueryKey = (
  options: Options<FormServicesGetPlanData>,
) => createQueryKey('formServicesGetPlan', options);

/**
 * Get form plan
 */
export const formServicesGetPlanOptions = (
  options: Options<FormServicesGetPlanData>,
) =>
  queryOptions<
    FormServicesGetPlanResponse,
    AxiosError<FormServicesGetPlanError>,
    FormServicesGetPlanResponse,
    ReturnType<typeof formServicesGetPlanQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Update form plan
 */
export const formServicesUpdatePlanMutation = (
  options?: Partial<Options<FormServicesUpdatePlanData>>,
): UseMutationOptions<
  FormServicesUpdatePlanResponse,
  AxiosError<FormServicesUpdatePlanError>,
  Options<FormServicesUpdatePlanData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesUpdatePlanResponse,
    AxiosError<FormServicesUpdatePlanError>,
 ...
 * Activate form plan
 */
export const formServicesActivatePlanMutation = (
  options?: Partial<Options<FormServicesActivatePlanData>>,
): UseMutationOptions<
  FormServicesActivatePlanResponse,
  AxiosError<FormServicesActivatePlanError>,
  Options<FormServicesActivatePlanData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesActivatePlanResponse,
    AxiosError<FormServicesActivatePlanError>,
 ...
 * Pause form plan
 */
export const formServicesPausePlanMutation = (
  options?: Partial<Options<FormServicesPausePlanData>>,
): UseMutationOptions<
  FormServicesPausePlanResponse,
  AxiosError<FormServicesPausePlanError>,
  Options<FormServicesPausePlanData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesPausePlanResponse,
    AxiosError<FormServicesPausePlanError>,
...
export const formServicesPreviewScheduleQueryKey = (
  options: Options<FormServicesPreviewScheduleData>,
) => createQueryKey('formServicesPreviewSchedule', options);

/**
 * Preview form plan schedule
 */
export const formServicesPreviewScheduleOptions = (
  options: Options<FormServicesPreviewScheduleData>,
) =>
  queryOptions<
    FormServicesPreviewScheduleResponse,
    AxiosError<FormServicesPreviewScheduleError>,
    FormServicesPreviewScheduleResponse,
    ReturnType<typeof formServicesPreviewScheduleQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const formServicesListReviewQueueQueryKey = (
  options: Options<FormServicesListReviewQueueData>,
) => createQueryKey('formServicesListReviewQueue', options);

/**
 * List review queue
 */
export const formServicesListReviewQueueOptions = (
  options: Options<FormServicesListReviewQueueData>,
) =>
  queryOptions<
    FormServicesListReviewQueueResponse,
    AxiosError<FormServicesListReviewQueueError>,
    FormServicesListReviewQueueResponse,
    ReturnType<typeof formServicesListReviewQueueQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const formServicesRecordAnswerReviewMutation = (
  options?: Partial<Options<FormServicesRecordAnswerReviewData>>,
): UseMutationOptions<
  FormServicesRecordAnswerReviewResponse,
  AxiosError<FormServicesRecordAnswerReviewError>,
  Options<FormServicesRecordAnswerReviewData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesRecordAnswerReviewResponse,
    AxiosError<FormServicesRecordAnswerReviewError>,
 ...
 */
export const formServicesCreateCorrectionMutation = (
  options?: Partial<Options<FormServicesCreateCorrectionData>>,
): UseMutationOptions<
  FormServicesCreateCorrectionResponse,
  AxiosError<FormServicesCreateCorrectionError>,
  Options<FormServicesCreateCorrectionData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesCreateCorrectionResponse,
    AxiosError<FormServicesCreateCorrectionError>,
...
export const formServicesUploadAttachmentMutation = (
  options?: Partial<Options<FormServicesUploadAttachmentData>>,
): UseMutationOptions<
  FormServicesUploadAttachmentResponse,
  AxiosError<FormServicesUploadAttachmentError>,
  Options<FormServicesUploadAttachmentData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesUploadAttachmentResponse,
    AxiosError<FormServicesUploadAttachmentError>,
 ...
 */
export const formServicesFinalizeReviewMutation = (
  options?: Partial<Options<FormServicesFinalizeReviewData>>,
): UseMutationOptions<
  FormServicesFinalizeReviewResponse,
  AxiosError<FormServicesFinalizeReviewError>,
  Options<FormServicesFinalizeReviewData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesFinalizeReviewResponse,
    AxiosError<FormServicesFinalizeReviewError>,
...
export const formServicesGetReviewDetailQueryKey = (
  options: Options<FormServicesGetReviewDetailData>,
) => createQueryKey('formServicesGetReviewDetail', options);

/**
 * Get submission review entries
 */
export const formServicesGetReviewDetailOptions = (
  options: Options<FormServicesGetReviewDetailData>,
) =>
  queryOptions<
    FormServicesGetReviewDetailResponse,
    AxiosError<FormServicesGetReviewDetailError>,
    FormServicesGetReviewDetailResponse,
    ReturnType<typeof formServicesGetReviewDetailQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const formServicesRecordSectionReviewMutation = (
  options?: Partial<Options<FormServicesRecordSectionReviewData>>,
): UseMutationOptions<
  FormServicesRecordSectionReviewResponse,
  AxiosError<FormServicesRecordSectionReviewError>,
  Options<FormServicesRecordSectionReviewData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesRecordSectionReviewResponse,
    AxiosError<FormServicesRecordSectionReviewError>,
 ...
 * Reorder form fields
 */
export const formServicesReorderFieldsMutation = (
  options?: Partial<Options<FormServicesReorderFieldsData>>,
): UseMutationOptions<
  FormServicesReorderFieldsResponse,
  AxiosError<FormServicesReorderFieldsError>,
  Options<FormServicesReorderFieldsData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesReorderFieldsResponse,
    AxiosError<FormServicesReorderFieldsError>,
...
export const formServicesDeleteFieldMutation = (
  options?: Partial<Options<FormServicesDeleteFieldData>>,
): UseMutationOptions<
  FormServicesDeleteFieldResponse,
  AxiosError<FormServicesDeleteFieldError>,
  Options<FormServicesDeleteFieldData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesDeleteFieldResponse,
    AxiosError<FormServicesDeleteFieldError>,
...
export const formServicesEditFieldMutation = (
  options?: Partial<Options<FormServicesEditFieldData>>,
): UseMutationOptions<
  FormServicesEditFieldResponse,
  AxiosError<FormServicesEditFieldError>,
  Options<FormServicesEditFieldData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesEditFieldResponse,
    AxiosError<FormServicesEditFieldError>,
 ...
 */
export const formServicesReorderSectionsMutation = (
  options?: Partial<Options<FormServicesReorderSectionsData>>,
): UseMutationOptions<
  FormServicesReorderSectionsResponse,
  AxiosError<FormServicesReorderSectionsError>,
  Options<FormServicesReorderSectionsData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesReorderSectionsResponse,
    AxiosError<FormServicesReorderSectionsError>,
 ...
 * Delete form section
 */
export const formServicesDeleteSectionMutation = (
  options?: Partial<Options<FormServicesDeleteSectionData>>,
): UseMutationOptions<
  FormServicesDeleteSectionResponse,
  AxiosError<FormServicesDeleteSectionError>,
  Options<FormServicesDeleteSectionData>
> => {
  const mutationOptions: UseMutationOptions<
    FormServicesDeleteSectionResponse,
    AxiosError<FormServicesDeleteSectionError>,
...
export const locationServiceListLocationsByCompanyQueryKey = (
  options: Options<LocationServiceListLocationsByCompanyData>,
) => createQueryKey('locationServiceListLocationsByCompany', options);

/**
 * Get locations by company
 */
export const locationServiceListLocationsByCompanyOptions = (
  options: Options<LocationServiceListLocationsByCompanyData>,
) =>
  queryOptions<
    LocationServiceListLocationsByCompanyResponse,
    AxiosError<LocationServiceListLocationsByCompanyError>,
    LocationServiceListLocationsByCompanyResponse,
    ReturnType<typeof locationServiceListLocationsByCompanyQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const locationServiceCreateLocationMutation = (
  options?: Partial<Options<LocationServiceCreateLocationData>>,
): UseMutationOptions<
  LocationServiceCreateLocationResponse,
  AxiosError<LocationServiceCreateLocationError>,
  Options<LocationServiceCreateLocationData>
> => {
  const mutationOptions: UseMutationOptions<
    LocationServiceCreateLocationResponse,
    AxiosError<LocationServiceCreateLocationError>,
...
export const locationServiceListLocationsByBranchQueryKey = (
  options: Options<LocationServiceListLocationsByBranchData>,
) => createQueryKey('locationServiceListLocationsByBranch', options);

/**
 * Get active locations by branch
 */
export const locationServiceListLocationsByBranchOptions = (
  options: Options<LocationServiceListLocationsByBranchData>,
) =>
  queryOptions<
    LocationServiceListLocationsByBranchResponse,
    AxiosError<LocationServiceListLocationsByBranchError>,
    LocationServiceListLocationsByBranchResponse,
    ReturnType<typeof locationServiceListLocationsByBranchQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const locationServiceSetPrimaryLocationMutation = (
  options?: Partial<Options<LocationServiceSetPrimaryLocationData>>,
): UseMutationOptions<
  LocationServiceSetPrimaryLocationResponse,
  AxiosError<LocationServiceSetPrimaryLocationError>,
  Options<LocationServiceSetPrimaryLocationData>
> => {
  const mutationOptions: UseMutationOptions<
    LocationServiceSetPrimaryLocationResponse,
    AxiosError<LocationServiceSetPrimaryLocationError>,
 ...
 */
export const locationServiceAssignSlotLocationMutation = (
  options?: Partial<Options<LocationServiceAssignSlotLocationData>>,
): UseMutationOptions<
  LocationServiceAssignSlotLocationResponse,
  AxiosError<LocationServiceAssignSlotLocationError>,
  Options<LocationServiceAssignSlotLocationData>
> => {
  const mutationOptions: UseMutationOptions<
    LocationServiceAssignSlotLocationResponse,
    AxiosError<LocationServiceAssignSlotLocationError>,
...
export const locationServiceUpdateSlotLocationMutation = (
  options?: Partial<Options<LocationServiceUpdateSlotLocationData>>,
): UseMutationOptions<
  LocationServiceUpdateSlotLocationResponse,
  AxiosError<LocationServiceUpdateSlotLocationError>,
  Options<LocationServiceUpdateSlotLocationData>
> => {
  const mutationOptions: UseMutationOptions<
    LocationServiceUpdateSlotLocationResponse,
    AxiosError<LocationServiceUpdateSlotLocationError>,
...
export const locationServiceGetSlotLocationsQueryKey = (
  options: Options<LocationServiceGetSlotLocationsData>,
) => createQueryKey('locationServiceGetSlotLocations', options);
...
export const locationServiceGetSlotLocationsOptions = (
  ...
  queryOptions<
    LocationServiceGetSlotLocationsResponse,
    AxiosError<LocationServiceGetSlotLocationsError>,
    LocationServiceGetSlotLocationsResponse,
    ReturnType<typeof locationServiceGetSlotLocationsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const locationServiceGetSlotLocationAssignmentsQueryKey = (
  options: Options<LocationServiceGetSlotLocationAssignmentsData>,
) => createQueryKey('locationServiceGetSlotLocationAssignments', options);
...
export const locationServiceGetSlotLocationAssignmentsOptions = (
  ...
  queryOptions<
    ...
    LocationServiceGetSlotLocationAssignmentsResponse,
    ReturnType<typeof locationServiceGetSlotLocationAssignmentsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Delete a location
 */
export const locationServiceDeleteLocationMutation = (
  options?: Partial<Options<LocationServiceDeleteLocationData>>,
): UseMutationOptions<
  LocationServiceDeleteLocationResponse,
  AxiosError<LocationServiceDeleteLocationError>,
  Options<LocationServiceDeleteLocationData>
> => {
  const mutationOptions: UseMutationOptions<
    LocationServiceDeleteLocationResponse,
    AxiosError<LocationServiceDeleteLocationError>,
...
export const locationServiceGetLocationQueryKey = (
  options: Options<LocationServiceGetLocationData>,
) => createQueryKey('locationServiceGetLocation', options);

/**
 * Get location by ID
 */
export const locationServiceGetLocationOptions = (
  options: Options<LocationServiceGetLocationData>,
) =>
  queryOptions<
    LocationServiceGetLocationResponse,
    AxiosError<LocationServiceGetLocationError>,
    LocationServiceGetLocationResponse,
    ReturnType<typeof locationServiceGetLocationQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Update a location
 */
export const locationServiceUpdateLocationMutation = (
  options?: Partial<Options<LocationServiceUpdateLocationData>>,
): UseMutationOptions<
  LocationServiceUpdateLocationResponse,
  AxiosError<LocationServiceUpdateLocationError>,
  Options<LocationServiceUpdateLocationData>
> => {
  const mutationOptions: UseMutationOptions<
    LocationServiceUpdateLocationResponse,
    AxiosError<LocationServiceUpdateLocationError>,
